...
signed main() {
  ...
  //     cout << "Round " << (i + 1) << ": 0x" << setw(12) << setfill('0') <<
  ...
  // cout << "Plaintext: 0x" << hex << setw(16) << setfill('0') << uppercase <<
  // plaintext << endl;

  // uint64_t ciphertext = des.encrypt(plaintext, roundKeys);
  // cout << "Ciphertext: 0x" << hex << setw(16) << setfill('0') << uppercase <<
  // ciphertext << endl;

  // uint64_t decryptedText = des.decrypt(ciphertext, roundKeys);
  // cout << "Decrypted Text: 0x" << hex << setw(16) << setfill('0') <<
  // uppercase << decryptedText << endl;
